...
format long
%fid = 1;
fid = fopen('SalidaDIRK.txt', 'w');

#############################
###DI RUNGE-KUTTA GENÉRICO###
#############################

%Implementaremos en los ejercicios el tablero de Butcher de DIRK2.m

ARK = [1/4, 0;
       1/2, 1/4]; %A : Matriz sxs
bRK = [1/2; 1/2]; %b : Vector VERTICAL (sx1)
cRK = [1/4; 3/4]; %c : Vector VERTICAL (sx1)
...
%fprintf(fid, '\n')
%[x,y,err_max] = DIRK(fid, a, b, 0.1, F, eta, ARK, bRK, cRK, exact)
%fprintf(fid, '\n')


%fprintf(fid, 'Longitud de paso h = %10.3e', 1.e-2)
%fprintf(fid, '\n')
%[x,y,err_max] = DIRK(fid, a, b, 0.01, F, eta, ARK, bRK, cRK, exact)
%fprintf(fid, '\n')


%fprintf(fid, 'Longitud de paso h = %10.3e', 1.e-3)
%fprintf(fid, '\n')
%[x,y,err_max] = DIRK(fid, a, b, 1.e-3, F, eta, ARK, bRK, cRK, exact)
%fprintf(fid, '\n')
...
fprintf(fid, '\n')
[x,y,err_max] = DIRK(fid, a, b, h, F, eta, ARK, bRK, cRK, exact)
fprintf(fid, '\n')
