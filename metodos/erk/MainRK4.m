...
fprintf(fid, '\n')
[x,y,err_max] = RK4(fid, a, b, 0.1, F, eta, exact)
fprintf(fid, '\n')


fprintf(fid, 'Longitud de paso h = %10.3e', 1.e-2)
fprintf(fid, '\n')
[x,y,err_max] = RK4(fid, a, b, 0.01, F, eta, exact)
fprintf(fid, '\n')


fprintf(fid, 'Longitud de paso h = %10.3e', 1.e-3)
fprintf(fid, '\n')
[x,y,err_max] = RK4(fid, a, b, 1.e-3, F, eta, exact)
fprintf(fid, '\n')
...
fprintf(fid, '\n')
[x,y,err_max] = RK4(fid, a, b, h, F, eta, exact)
fprintf(fid, '\n')
